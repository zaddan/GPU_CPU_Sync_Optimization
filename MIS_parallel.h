...
extern _CPPSTRING_ void mis_parallel_async(int* nodes,float* nodes_randvalues,int* nodes_status,int* indexarray,int* execute,char* ready, const snk_lparm_t * lparm);
