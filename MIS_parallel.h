...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void mis_parallel(int* nodes,float* nodes_randvalues,int* nodes_status,int* numofnodes,int* indexarray,int* execute, const snk_lparm_t * lparm);
extern _CPPSTRING_ void mis_parallel_async(int* nodes,float* nodes_randvalues,int* nodes_status,int* numofnodes,int* indexarray,int* execute,int* ready, const snk_lparm_t * lparm);
