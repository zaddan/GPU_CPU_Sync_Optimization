...
extern _CPPSTRING_ void csquares_async(int* nodes,float* nodes_randvalues,int* nodes_status,int* numofnodes,int* indexarray,int* execute,int* ready, const snk_lparm_t * lparm);
