...
echo $cxx -O3 -o MIS_parallel_async MIS_parallel.o MIS_parallel_async.cpp_async.cpp debug_helpers.cpp -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf
$cxx -O3 -o MIS_parallel_async MIS_parallel.o MIS_parallel_async.cpp  debug_helpers.cpp -L$HSA_RUNTIME_PATH/lib -lhsa-runtime64 -lelf
