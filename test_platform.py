...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#---------guide::: generate a random graph
counter  = 0
for i in range (0, 10):
	while not(generate_random_graphs(50, sparseRepFileName)):
	...
	#
        ...
        logFileName = "./log/log_" +str(time.time()) + ".txt"
...
#	#---------guide::: run the parallel code
	os.system("./buildrun.sh")
        os.system("./MIS_parallel" + " " + sparseRepFileName + " " + MISResultToVerifyFileNameParallel); 
        logFilePtr = open(logFileName, "a");
        logFilePtr.write("\n");
        logFilePtr.write("\n");
...
#	##---------guide::: verify
	print "verifying the parallel exection...."
        ...
        #logFilePtr.write("*******************************************************************************************************************\n")
        logFilePtr.close() 
        verifyMaximalSet(sparseRepFileName,  MISResultToVerifyFileNameParallel, logFileName)
